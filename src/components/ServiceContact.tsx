                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    {(officeAddress || email || phone) && (
                        <div className="lg:col-span-5 space-y-8">
                            ...
                            {/* Map Box Placeholder */}
                            <div className="w-full h-72 bg-slate-800 rounded-xl overflow-hidden shadow-md relative border border-slate-700">
                                <div className="absolute inset-0 flex items-center justify-center text-slate-500 font-medium">
                                    <div className="text-center">
                                        <svg className="w-10 h-10 mx-auto mb-2 opacity-40 text-brand-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                                        </svg>
                                        <span className="text-sm">Location Map (Delhi / Noida)</span>
                                    </div>
                                </div>
                            </div>
